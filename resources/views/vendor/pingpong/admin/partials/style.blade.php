...
<link href="{!! admin_asset('components/fontawesome/css/font-awesome.min.css') !!}" rel="stylesheet" type="text/css"/>
<!-- Ionicons -->
...
<link rel="stylesheet" href="{!! admin_asset('css/mab-jquery-taginput.css') !!}">
<!-- <link href="{!! admin_asset('css/bootstrap-tagsinput.css') !!}" rel="stylesheet" type="text/css"/> -->