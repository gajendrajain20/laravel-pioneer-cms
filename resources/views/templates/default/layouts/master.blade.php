...
<html lang="en">
    ...
    <body>
        ...
        <div class="container container_padding">
            ...
            <div class="col-sm-12">
                <div class="row">
                    <?php echo App::make("Modules\Frontend\Http\Controllers\FrontendController")->getAllWidgets('left-c'); ?>
                </div>
            ...
            <div class="col-sm-8 content_left">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            <?php echo App::make("Modules\Frontend\Http\Controllers\FrontendController")->getAllWidgets('left-d'); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 video_block">
                <div class="row">
                    <?php echo App::make("Modules\Frontend\Http\Controllers\FrontendController")->getVideo(); ?>
                </div>
